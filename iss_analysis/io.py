...
def filter_genes(gene_names):
    ...
    #filtered_genes = np.array(np.load("/camp/lab/znamenskiyp/home/shared/resources/allen2018/low_genes.npy", allow_pickle=True))
    #genes_low = np.array([gene not in filtered_genes for gene in gene_names])
    #gene_set_petr = np.asarray(['Rcan2','Pvalb','Olfm3','Prss23','Pantr1','Stxbp6',
    #'Chn2','Nov','Cpne6','Fst','Gpx3','Hpcal4','Serpine2','Dkk3','Cartpt','Rspo1',
    #'Cxcl14','Lypd6b','Vip','Cryab','Thsd7a','Mdh1',
    #'Nefl','Lypd6','Rbp4','Spon1','Cdh13','Sparcl1','Spock3',
    #'Cd24a','Snca','Rgs10','Gad1','Chrm2','Gap43','Etv1',
    #'Itm2c','Kcnab1','Cxcl12','Myl4',
    #'Arpp21','Nnat','Brinp3','Cplx3','Pcdh8','Pcp4l1','Cnr1',
    #'Stmn2','Nrep','Tac2','Sst','Synpr','Pdyn','Calb2','Enpp2',
    #'Id2','Igfbp4','Lamp5','Marcksl1','Crh','Ncald','Npy',
    #'Nr4a2','Nrsn1','Pcp4','Pde1a','Gabra1','Penk','Ptn',
    #'Rab3b','Reln','Rgs4','Cck','Scg2','Serpini1','Calb1'])
    #genes_low = np.array([gene not in gene_set_petr for gene in gene_names])
